  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute top-1/3 left-1/4 w-1.5 h-1.5 bg-purple-500/80 rounded-full opacity-0 animate-pulse shadow-sm"
          style={{ animationDelay: "1.8s" }}
        />
        <div
          className="absolute top-2/3 right-1/4 w-1.5 h-1.5 bg-pink-500/80 rounded-full opacity-0 animate-pulse shadow-sm"
          style={{ animationDelay: "2.1s" }}
        />
        <div
          className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 bg-orange-500/80 rounded-full opacity-0 animate-pulse shadow-sm"
          style={{ animationDelay: "2.4s" }}
        />
        <div
          className="absolute top-1/4 right-1/3 w-1.5 h-1.5 bg-purple-600/80 rounded-full opacity-0 animate-pulse shadow-sm"
          style={{ animationDelay: "2.7s" }}
        />
        <div
          className="absolute bottom-1/4 left-2/5 w-1.5 h-1.5 bg-pink-600/80 rounded-full opacity-0 animate-pulse shadow-sm"
          style={{ animationDelay: "3s" }}
        />
        <div
          className="absolute top-1/5 left-2/3 w-1.5 h-1.5 bg-orange-600/80 rounded-full opacity-0 animate-pulse shadow-sm"
      ...
      <div className="text-center space-y-10 -mt-20">
        ...
        <div ref={textWrapperRef} className="space-y-5 will-change-transform">
          ...
          <p
            ...
            style={{
              textShadow:
                "1px 1px 2px rgba(120, 88, 255, 0.1), 0px 2px 4px rgba(120, 88, 255, 0.05)",
              filter: "drop-shadow(0px 1px 1px rgba(120, 88, 255, 0.1))",
            }}
          ></p>
          <p
            className="typewriter-text text-pink-600 font-secondary text-xl md:text-2xl font-medium tracking-wide"
            style={{
              textShadow:
                "1px 1px 2px rgba(248, 60, 133, 0.1), 0px 2px 4px rgba(248, 60, 133, 0.05)",
              filter: "drop-shadow(0px 1px 1px rgba(248, 60, 133, 0.1))",
            }}
          ></p>
          <p
            className="typewriter-text text-orange-600 font-secondary text-xl md:text-2xl font-medium tracking-wide"
            style={{
              textShadow:
                "1px 1px 2px rgba(247, 103, 2, 0.1), 0px 2px 4px rgba(247, 103, 2, 0.05)",
